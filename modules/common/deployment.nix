    ...
    type = lib.types.submodule {
      options = {
        allowLocalDeployment = lib.mkOption {
          type = lib.types.bool;
          default = false;
          description = "Allow the configuration to be applied locally on the host running Colmena.";
        };
            ...
            lib.types.submodule {
              options = {
                ...
                keyCommand = lib.mkOption {
                  ...
                  default = null;
                  description = "Command to run to generate the key. One of text, keyCommand and keyFile must be set.";
                };

                keyFile = lib.mkOption {
                  type = lib.types.nullOr lib.types.path;
                  default = null;
                  description = "Path of the local file to read the key from. One of text, keyCommand and keyFile must be set.";
                };
                ...
                text = lib.mkOption {
                  ...
                  default = null;
                  description = "Content of the key. One of text, keyCommand and keyFile must be set.";
                };
        ...
        privilegeEscalationCommand = lib.mkOption {
          ...
          description = "Command to use to elevate privileges when activating the new profiles on SSH hosts.";
        };

        replaceUnknownProfiles = lib.mkOption {
          type = lib.types.bool;
          default = true;
          description = "Allow a configuration to be applied to a host running a profile we have no knowledge of.";
        };
