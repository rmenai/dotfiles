...
wt.on("format-tab-title", function(tab, _, _, config, hover, max_width)
  if config.use_fancy_tab_bar or not config.enable_tab_bar then return end
  ...
  -- Title:append(fg, bg, (unseen_output and Icon.Notification or Icon.Nums[tab_idx + 1] or "") .. " ", attributes)
