...
M.setup_leetcode_cmds = function()
  ...
  local commands = {
    ...
    { name = "LeetInfo", cmd = leet_cmds.info[1], desc = "Show information for the current question" },
    ...
    { name = "LeetLang", cmd = leet_cmds.lang[1], desc = "Change language for the current question" },
    ...
    { name = "LeetReset", cmd = leet_cmds.reset[1], desc = "Reset the current question to the default template" },
